                    ...
                    <form class="uk-form uk-form-horizontal" id="upload-question-form" ref="uploadQuestions">
                        ...
                        <div>
                            ...
                            <div class="uk-form-controls-text">
                                <textarea name="question" id="question" cols="10" rows="5" v-model="question.text" class="uk-textarea"></textarea>
                            </div>
                        </div>
                        <hr class="uk-divider">
                        <div>
                            ...
                            <fieldset class="uk-fieldset">
                                ...
                                <div class="uk-flex uk-flex-row uk-flex-wrap">
                                    <div class="uk-flex uk-flex-row uk-flex-wrap">
                                        ...
                                        <div class="uk-form-controls">
                                            <input type="radio" class="uk-radio" id="correct-option-a" v-model="question.correct" name="correct" value="a">
                                        </div>
                                    </div>
                                    <div class="uk-flex uk-flex-row uk-flex-wrap">
                                        <label for="correct-option-b">Option B</label>
                                        <div class="uk-form-controls">
                                            <input type="radio" class="uk-radio" id="correct-option-b" v-model="question.correct" name="correct" value="b">
                                        </div>
                                    </div>
                                    <div class="uk-flex uk-flex-row uk-flex-wrap">
                                        <label for="correct-option-c">Option C</label>
                                        <div class="uk-form-controls">
                                            <input type="radio" class="uk-radio" id="correct-option-c" v-model="question.correct" name="correct"  value="c">
                                        </div>
                                    </div>
                                    <div class="uk-flex uk-flex-row uk-flex-wrap">
                                        <label for="correct-option-d">Option D</label>
                                        <div class="uk-form-controls">
                                            <input type="radio" class="uk-radio" id="correct-option-d" v-model="question.correct" name="correct"  value="d">
                                        </div>
                                    </div>
                        ...
                        <div>
                            ...
                            <label for="picture" class="uk-form-label">File</label>
                            <div class="uk-form-controls">
                                <input type="file" name="picture" id="picture" class="uk-input" ref="picture" @change="pictureChange()">
                            </div>
                        </div>
                        </div>
                    </form>
