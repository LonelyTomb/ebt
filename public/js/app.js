...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_uikit__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_uikit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_uikit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uikit_dist_js_uikit_icons__ = __webpack_require__(20);
...
Vue.component('admin-login-component', __webpack_require__(40));
Vue.component('login-component', __webpack_require__(43));
Vue.component('register-component', __webpack_require__(46));
Vue.component('bulk-register-component', __webpack_require__(49));
Vue.component('bulk-register-preview-component', __webpack_require__(16));

/**
 * Courses components
 **/

Vue.component('create-course', __webpack_require__(57));

/**
 * Questions components
 **/

Vue.component('upload-questions', __webpack_require__(60));
// Vue.component('preview-upload-questions', require('./components/epanel/questions/uploadPreview.vue'));
Vue.component('input-question', __webpack_require__(68));

/**
 * User Management Components
 */
Vue.component('user-controls-component', __webpack_require__(71));

/**
 * User Components
 * */
Vue.component('home-component', __webpack_require__(76));
...
var update = __webpack_require__(3)("1a3b7844", content, false, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bulkRegisterPreview_vue__ = __webpack_require__(16);
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-dfa095e8"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("11392521", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dfa095e8\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./upload.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dfa095e8\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./upload.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.uk-form-custom[data-v-dfa095e8]:hover {\n  cursor: pointer !important;\n}\n.uk-close-large[data-v-dfa095e8] {\n  position: absolute;\n  right: 4%;\n}\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uploadPreview_vue__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uploadPreview_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__uploadPreview_vue__);
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "UploadQuestion",
  components: {
    "upload-preview": __WEBPACK_IMPORTED_MODULE_0__uploadPreview_vue___default.a
  },
  props: {
    courses: Array
  },
...
Component.options.__file = "resources/assets/js/components/epanel/questions/uploadPreview.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-86e9a568", Component.options)
  } else {
    hotAPI.reload("data-v-86e9a568", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    save: function save() {
      ...
      window.UIkit.modal.alert("Saving to Database. Please Wait");
      window.axios.post("/epanel/questions/save", {
        course: this.course,
        questions: this.questions
      }).then(function (res) {
        _this.closeModal();
        window.UIkit.notification(res.data.status + ", " + res.data.count + " questions saved", "success");
        window.location.replace("/epanel/");
      }).catch(function (err) {
        _this.closeModal();
        window.UIkit.notification("Unable to complete! Please try again", "danger");
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-86e9a568", module.exports)
  }
}
        ...
        [
          _vm.processedList.length == 0
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "uk-table uk-table-responsive uk-table-small uk-background-secondary"
                          },
                          [
                            _c("thead", [
                              _c(
                            ...
                            [
                              this.questions.list.length == 0
                                ...
                                : _c(
                                    ...
                                    [
                                      _c("span", [
                                        _vm._v(_vm._s(this.questions.list.name))
                                      ]),
                                      _vm._v(" "),
                                      _c("button", {
                                        staticClass: "uk-close-large",
            ...
            : _c(
                ...
                {
                  attrs: {
                    questions: _vm.processedList,
                    course: _vm.questions.course
                  }
                },
                [
                  _c(
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "uk-card-header uk-card-primary" }, [
      _c("h3", { staticClass: "uk-heading" }, [_vm._v("Upload Questions")])
    ])
  }
]
render._withStripped = true
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("a3d994e4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dataTable__ = __webpack_require__(88);
  ...
  return _c(
    ...
    [
      _c("data-table", {
        ...
        on: { "selected-items": _vm.selectedItems }
      })
    ],
    1
  )
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-32a6871c", Component.options)
  } else {
    hotAPI.reload("data-v-32a6871c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("22e6c05a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-32a6871c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./home.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-32a6871c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./home.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("article", { staticClass: "uk-container uk-box-shadow-xlarge" }, [
      _c("section", { staticClass: "uk-margin-medium-top" }, [
        _c("ul", { staticClass: "uk-flex-center", attrs: { "uk-tab": "" } }, [
          _c("li", { staticClass: "uk-active" }, [
            _c("a", { attrs: { href: "#" } }, [_vm._v("Check Profile")])
          ]),
          _vm._v(" "),
          _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Take Test")])]),
          _vm._v(" "),
          _c("li", [
            _c("a", { attrs: { href: "#" } }, [_vm._v("View Scripts/Results")])
          ])
        ])
      ])
    ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-32a6871c", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("325a0726", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
        ...
        _c("div", [
          _c(
            "button",
            {
              ...
              on: {
                click: function($event) {
                  _vm.$emit("selected-items", _vm.selectedItems)
                }
              }
            },
